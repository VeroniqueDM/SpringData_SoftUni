...
public class T6_RemoveVillain {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        final PreparedStatement getVillainNameStatement = sqlConnection.prepareStatement(GET_VILLAIN_NAME_BY_ID);
        getVillainNameStatement.setInt(1, villainId);

        final ResultSet villainResultSet = getVillainNameStatement.executeQuery();
